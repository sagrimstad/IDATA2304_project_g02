...
public class SensorActuatorNode implements ActuatorListener, CommunicationChannelListener {
   ...
   *
   * @param template The template to use for the sensors. The template will be cloned. This template
   *                 defines the type of sensors, the value range, value generation algorithms,
   *                 etc.
   ...
   *
   * @param isReady When true, let them know that this node is ready; when false - that this node is
   *                shut down
   */
