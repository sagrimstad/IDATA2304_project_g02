...
public class Actuator {
   ...
   * @param diffWhenActive What will be the introduced difference in the sensor reading when the
   *                       actuator is active. For example, if this value is 2.0 and the sensorType
   *                       is "temperature", this means that "activating this actuator will increase
   *                       the readings of temperature sensors attached to the same node by +2
   *                       degrees".
   */
