package no.ntnu.idata2304.project.gui.common;
...
public class SensorPane extends TitledPane {
  ...
  /**
   * Create a sensor pane. Wrapper for the other constructor with SensorReading-iterable parameter
   *
   * @param sensors The sensor data to be displayed on the pane.
   */
  ...
  /**
   * Update the GUI according to the changes in sensor data. Wrapper for the other method with
   * SensorReading-iterable parameter
   *
   * @param sensors The sensor data that has been updated
   */
