 ...
 * part, where the real node object is available. This event will (probably) not be useful on the
 * control panel side.
 */
public interface NodeStateListener {

  /**
   * This event is fired when a sensor/actuator node has finished the starting procedure and has
